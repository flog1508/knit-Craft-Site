  ...
  return (
    <div className="min-h-screen bg-primary-950 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl sm:text-5xl font-bold text-primary-50 mb-10">
          Conditions Générales de Vente
        </h1>

        <Card className="p-8 space-y-8 bg-primary-900/70 border-primary-800 text-primary-50">
          <div>
            <h2 className="text-2xl font-bold mb-4">1. Conditions d&apos;accès au site</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">3. Processus de Commande</h2>
            <p className="text-accent-100 leading-relaxed mb-3">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">4. Commandes Personnalisées</h2>
            <p className="text-accent-100 leading-relaxed">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">5. Paiement et Livraison</h2>
            <p className="text-accent-100 leading-relaxed mb-3">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">6. Retours et Remboursements</h2>
            <p className="text-accent-100 leading-relaxed">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">9. Modification des CGV</h2>
            <p className="text-accent-100 leading-relaxed">
