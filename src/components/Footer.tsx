        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              />
              <span className="font-bold text-lg">Knit & Craft</span>
            </div>
            <p className="text-gray-400 text-sm">Creations artisanales de tricot et crochet fait main</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/shop?category=pullovers" className="text-gray-400 hover:text-white transition-colors">
                  Pulls & Gilets
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/bespoke" className="text-gray-400 hover:text-white transition-colors">
                  Commande sur mesure
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href={`https://wa.me/${CONTACT_PHONE.replace(/\D/g, '')}?text=${WHATSAPP_MSG}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  {CONTACT_PHONE}
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4" />
                <a href={`mailto:${CONTACT_EMAIL}?subject=${MAILTO_SUBJECT}&body=${MAILTO_BODY}`} className="text-gray-400 hover:text-white transition-colors">
                  {CONTACT_EMAIL}
                </a>
              </li>
              <li className="flex gap-3 mt-3">
                <a href="https://www.instagram.com/knit.and.craft/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
                <a href="https://www.tiktok.com/@knit.and.craft" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
